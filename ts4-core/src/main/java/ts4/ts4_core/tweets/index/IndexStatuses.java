/* Copied from twitter-tools, used to generate index for a collection
 * Run: sh target/appassembler/bin/IndexStatuses -collection {collectionPath} -index {indexPath} -optimize
 */
