 ...
 * Run: sh target/appassembler/bin/RunQueries -index {indexPath} -stats {statsPath} -clusters {clustersPath}
...
public class RunQueriesDaily {
	private static final Logger LOG = Logger.getLogger(RunQueriesDaily.class);
